...
public class SearchModuleEnum {
    ...
    public static final String SEARCH_ADVANCED_CUSTOMER = "SEARCH_ADVANCED_CUSTOMER"; // 客户
    public static final String SEARCH_ADVANCED_CONTACT = "SEARCH_ADVANCED_CONTACT"; // 联系人
    public static final String SEARCH_ADVANCED_PUBLIC = "SEARCH_ADVANCED_PUBLIC"; // 公海
