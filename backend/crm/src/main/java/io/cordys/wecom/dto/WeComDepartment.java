...
public class WeComDepartment {
    ...
    public static List<WeComDepartment> buildDepartmentTree(List<WeComDepartment> departments) {
        ...
        for (WeComDepartment department : departments) {
            ...
            department.setCrmId(IDGenerator.nextStr());  // 生成新的 ID
            department.setCrmParentId(department.getParentId() == 0 ? "100001" : department.getCrmParentId()); // 生成新的 ParentId
        }
