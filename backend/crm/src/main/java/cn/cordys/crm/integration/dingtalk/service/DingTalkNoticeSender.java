...
public class DingTalkNoticeSender extends AbstractNoticeSender {
    ...
    private void sendDingTalk(String context, NoticeModel noticeModel, String organizationId, String subjectText) {
        ...
        //获取企业微信通知的配置数据
        OrganizationConfigDetail orgConfigDetailByIdAndType = extOrganizationConfigDetailMapper.getOrgConfigDetailByIdAndType(organizationConfig.getId(), ThirdConstants.ThirdDetailType.DINGTALK_NOTICE.toString());
        ...
        tokenService.sendDingNoticeByToken(dingTalkSendDTO, thirdConfigurationDTO.getCorpId(), thirdConfigurationDTO.getAppSecret());
    }
}
