...
INSERT INTO sys_role(id, name, internal, data_scope, create_time, update_time, create_user, update_user, description,
                     organization_id)
VALUES ('org_admin', 'org_admin', 1, 'ALL', UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000, 'admin', 'admin', '',
        '100001');

-- 初始化销售经理
INSERT INTO sys_role(id, name, internal, data_scope, create_time, update_time, create_user, update_user, description,
                     organization_id)
VALUES ('sales_manager', 'sales_manager', 1, 'DEPT_AND_CHILD', UNIX_TIMESTAMP() * 1000 + 1, UNIX_TIMESTAMP() * 1000 + 1,
        'admin', 'admin', '', '100001');
