-- 初始化用于项目级别权限测试的用户
INSERT INTO `sys_user` (`id`, `name`, `email`, `password`,  `enable`, `phone`, `create_time`,
                        `update_time`, `create_user`, `update_user`)
VALUES ('permission_test', 'permission_test', 'permission_test@cordys-crm.io', MD5('CordysCRM'), 1,'1253465576',
