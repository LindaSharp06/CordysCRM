-- 初始化用户
INSERT INTO `sys_user`(`id`, `name`, `phone`, `email`, `password`, `gender`, `create_time`, `update_time`, `create_user`, `update_user`)
VALUES
    ('1', '用户1', '1234567', '1@cordys-crm.io', '4706261da78b85ec9553be61a15f924c', 1, 1716175907000, 1729752373360, '717345437786112', 'admin'),
    ('2', '用户2', '2234567', '2@cordys-crm.io', '4706261da78b85ec9553be61a15f924c', 1, 1716175907000, 1729752373360, '717345437786112', 'admin'),
    ('3', '用户3', '3234567', '3@cordys-crm.io', '4706261da78b85ec9553be61a15f924c', 0, 1716175907000, 1729752373360, '717345437786112', 'admin'),
    ('4', '用户4', '4234567', '4@cordys-crm.io', '4706261da78b85ec9553be61a15f924c', 0, 1716175907000, 1729752373360, '717345437786112', 'admin'),
    ('5', '用户5', '5234567', '5@cordys-crm.io', '4706261da78b85ec9553be61a15f924c', 1, 1716175907000, 1729752373360, '717345437786112', 'admin');
