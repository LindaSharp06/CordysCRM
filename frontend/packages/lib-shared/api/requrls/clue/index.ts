...
export const GetClueFollowPlanListUrl = '/clue/follow/plan/page'; // 获取跟进计划列表
...
export const UpdateClueFollowPlanStatusUrl = '/clue/follow/plan/status/update'; // 更新线索跟进计划状态
...
export const GetAdvancedCluePoolListUrl = '/advanced/search/clue-pool'; // 全局搜索分页查询线索池线索
